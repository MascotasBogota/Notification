...
class TestNotificationController:
    ...
    @patch('src.utils.auth.get_jwt')
    @patch('src.controllers.notification_controller.notification_service')
    def test_get_user_notifications_success(self, mock_service, mock_get_jwt, mock_get_jwt_identity, mock_verify_jwt):
        """Test obtener notificaciones de usuario exitosamente"""
        # Configurar mocks
        mock_verify_jwt.return_value = None  # No error
        mock_get_jwt_identity.return_value = 'user123'
    ...
    @patch('src.utils.auth.get_jwt_identity')
    @patch('src.controllers.notification_controller.notification_service')
    def test_get_user_notifications_invalid_page(self, mock_service, mock_get_jwt_identity, mock_verify_jwt):
    ...
    @patch('src.utils.auth.get_jwt_identity')
    @patch('src.controllers.notification_controller.notification_service')
    def test_get_notification_by_id_success(self, mock_service, mock_get_jwt_identity, mock_verify_jwt):
    ...
    @patch('src.utils.auth.get_jwt_identity')
    @patch('src.controllers.notification_controller.notification_service')
    def test_get_notification_by_id_not_found(self, mock_service, mock_get_jwt_identity, mock_verify_jwt):
    ...
    @patch('src.utils.auth.get_jwt_identity')
    @patch('src.controllers.notification_controller.notification_service')
    def test_mark_notification_as_read_success(self, mock_service, mock_get_jwt_identity, mock_verify_jwt):
